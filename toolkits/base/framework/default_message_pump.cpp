...
DefaultMessagePump::DefaultMessagePump() : event_(false, false), should_quit_(0) {}
...
void DefaultMessagePump::WaitTimeout(const TimeDelta &timeout) { event_.WaitTimeout(timeout); }
